...
#pragma endregion
	...
	private: void loadData(int index)
	{
		...
		this->txt_dateliv->Text = Convert::ToString(this->ds->Tables["liste"]->Rows[this->index]->ItemArray[1]);
		this->txt_dateemi->Text = Convert::ToString(this->ds->Tables["liste"]->Rows[this->index]->ItemArray[2]);
	}
	...
	{
		this->oSvc->ajouterUneCommande(this->txt_ref->Text, this->txt_dateliv->Text, this->txt_dateemi->Text, Convert::ToInt32(this->textBox1->Text), Convert::ToDecimal(this->textBox3->Text), Convert::ToDecimal(this->textBox2->Text), Convert::ToDecimal(this->textBox5->Text), Convert::ToInt32(this->textBox4->Text));
	}
	...
	private: System::Void btn_update_Click(System::Object^ sender, System::EventArgs^ e) {
		this->oSvc->modifierUneCommande(Convert::ToInt32(this->txt_id->Text), this->txt_ref->Text, this->txt_dateliv->Text, this->txt_dateemi->Text, Convert::ToInt32(this->textBox1->Text), Convert::ToDecimal(this->textBox3->Text), Convert::ToDecimal(this->textBox2->Text), Convert::ToDecimal(this->textBox5->Text), Convert::ToInt32(this->textBox4->Text));
	}
