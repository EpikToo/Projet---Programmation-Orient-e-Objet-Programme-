...
#pragma endregion
	...
	{
		this->oSvc->ajouterUnArticle(this->txt_ref->Text, this->txt_des->Text, Convert::ToDouble(this->txt_prix_ht->Text), Convert::ToInt32(this->txt_taux->Text), this->txt_coul->Text, this->txt_pro->Text, Convert::ToInt32(this->txt_id_c->Text), Convert::ToInt32(this->txt_id_cat));
	}
	...
	private: System::Void btn_update_Click(System::Object^ sender, System::EventArgs^ e) {
		this->oSvc->modifierUnArticle(Convert::ToInt32(this->txt_id_a->Text), this->txt_ref->Text, this->txt_des->Text, Convert::ToDouble(this->txt_prix_ht->Text), Convert::ToInt32(this->txt_taux->Text), this->txt_coul->Text, this->txt_pro->Text, Convert::ToInt32(this->txt_id_c->Text), Convert::ToInt32(this->txt_id_cat));
	}
