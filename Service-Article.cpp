...
void NS_Comp_Svc9::CLservices::ajouterUnArticle(System::String^ reference, System::String^ designation, System::Decimal^ prix_produit_HT, System::Decimal^ taux_TVA, System::String^ couleur, System::String^ produit, System::Int32^ id_commande, System::Int32^ id_catalogue)
{
	System::String^ sql;
...
void NS_Comp_Svc9::CLservices::modifierUnArticle(System::Int32^ id, System::String^ reference, System::String^ designation, System::Decimal^ prix_produit_HT, System::Decimal^ taux_TVA, System::String^ couleur, System::String^ produit, System::Int32^ id_commande, System::Int32^ id_catalogue)
{
	System::String^ sql;
