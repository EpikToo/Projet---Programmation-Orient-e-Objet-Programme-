...
{
	return "SELECT * FROM [POO].[dbo].[Client] FULL JOIN [POO].[dbo].[Posseder] ON Client.id_client = Posseder.id_client FULL JOIN Adresse ON Adresse.id_adresse = Posseder.id_adresse";
}
